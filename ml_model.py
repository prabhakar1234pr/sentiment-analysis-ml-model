...
KAGGLE_USERNAME="prabhakarpr"
KAGGLE_KEY="302d82d1af7f17d85dde650eaa572025"
...
config_path = os.path.expanduser('~/.kaggle')
if not os.path.exists(config_path):
    os.makedirs(config_path)

# Copy the kaggle.json file to the ~/.kaggle directory
shutil.copy(kaggle_path, os.path.join(config_path, 'kaggle.json'))

# Ensure the file has the correct permissions (read-only for security)
os.chmod(os.path.join(config_path, 'kaggle.json'), 0o600)

...
# Set the path for the kaggle.json file in your repository
kaggle_path = './.kaggle/kaggle.json'
config_path = os.path.expanduser('~/.config/kaggle')

# Create the .config/kaggle directory if it doesn't exist
if not os.path.exists(config_path):
    os.makedirs(config_path)

# Move the kaggle.json file to the .config/kaggle directory
shutil.copy(kaggle_path, config_path)
